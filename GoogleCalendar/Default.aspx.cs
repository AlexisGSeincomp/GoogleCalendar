...
namespace GoogleCalendar
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private static string calID = "alexisg@seincomp.com.ar"; //System.Configuration.ConfigurationManager.AppSettings["GoogleCalendarID"].ToString()
        private static string UserId = "alexisg"; //System.Web.HttpContext.Current.User.Identity.Name
        ...
        protected void BtnLogin_Click(object sender, EventArgs e)
        {
             ...
             && XmlDoc.DocumentElement.ChildNodes[0].Attributes[Password].Value.ToLower() == TxtBoxPwd.Text.ToLower())
            {
                ...
                if (string.IsNullOrEmpty(XmlDoc.DocumentElement.ChildNodes[0].Attributes[AccessToken].Value.ToString()) ||
                string.IsNullOrEmpty(XmlDoc.DocumentElement.ChildNodes[0].Attributes[RefreshToken].Value.ToString()))
                {
                    PnlLogin.Visible = false;
                    PnlRegister.Visible = true;
                    PnlEvents.Visible = false;
