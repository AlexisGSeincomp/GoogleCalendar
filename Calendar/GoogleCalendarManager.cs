...
{
    private static string calID = "alexis.grebe.97@gmail.com"; //System.Configuration.ConfigurationManager.AppSettings["GoogleCalendarID"].ToString()
    private static string UserId = "alexis.grebe.97"; //System.Web.HttpContext.Current.User.Identity.Name
